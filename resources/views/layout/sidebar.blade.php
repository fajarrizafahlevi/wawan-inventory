    ...
    <div class="app-sidebar">
        <div class="side-header">
            <a class="header-brand1" href="index.html">
                <img src="{{asset('sash/assets/images/brand/logo.png')}}" class="header-brand-img desktop-logo" alt="logo">
                <img src="{{asset('sash/assets/images/brand/logo-1.png')}}" class="header-brand-img toggle-logo" alt="logo">
                <img src="{{asset('sash/assets/images/brand/logo-2.png')}}" class="header-brand-img light-logo" alt="logo">
                <img src="{{asset('sash/assets/images/brand/logo-3.png')}}" class="header-brand-img light-logo1" alt="logo">
            </a>
            <!-- LOGO -->
        </div>
                ...
                <li class="slide">
                    ...
                    <ul class="slide-menu">
                        ...
                        <li class="sub-slide">
                            ...
                            <ul class="sub-slide-menu">
                                <li><a class="sub-slide-item" href="switcher-1.html">Switcher Style 1</a></li>
                                <li><a class="sub-slide-item" href="switcher-2.html">Switcher Style 2</a></li>
                            </ul>
                        </li>
                    </ul>
                </li>
